...
# training with VI
start_time <- Sys.time()
res_VI_BPM <- BPM_training_Normal(X = dat[["X"]], Y = dat[["Y"]], Ts = Ts, b = b, alpha = alpha, mu_Mu = mu_Mu, sigma2_Mu = sigma2_Mu, alpha_Lambda = alpha_Lambda, beta_Lambda = beta_Lambda, VI = TRUE, nskip = 2, seed = 1)
end_time <- Sys.time()
end_time - start_time # 8.143002 secs
```
